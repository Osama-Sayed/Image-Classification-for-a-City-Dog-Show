...
#                                                                             
# PROGRAMMER: Osama Sayed Fathy
# DATE CREATED: 28/3/2020                         
# REVISED DATE: 
...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       #
       # Processes the results    so they can be compared with pet image lab        # set labels to lowercase (lower) and stripping off whitespace(strip)
       ...
       if truth in model_label:
        ...
        #results_dic[key][1].extend([model_label])
